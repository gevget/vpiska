...
const ContactForm = () => {
  ...
  return (
    <section
      ...
      {...section.bind}
      style={section.style}
      className="relative w-full border-t border-zinc-800 bg-black px-6 py-24 sm:px-12 sm:py-32 lg:px-20 xl:px-32 xl:py-40"
    >
      <div className="mx-auto grid w-full max-w-[2000px] grid-cols-1 items-center gap-20 lg:grid-cols-2">
        <div className="space-y-12">
          <div className="space-y-6">
            <span
              {...eyebrow.bind}
              style={eyebrow.style}
              className="block text-[10px] font-mono font-black uppercase tracking-[0.4em] text-zinc-500 sm:text-xs"
            >
              {eyebrow.text}
            </span>
            <h2
              {...title.bind}
              style={title.style}
              className="font-display text-[42px] font-black uppercase leading-[0.85] tracking-tighter text-white sm:text-[72px] lg:text-[90px]"
            >
              {title.text}
            </h2>
          </div>
          ...
          <div className="max-w-md space-y-8">
            ...
            <div className="space-y-4">
              <div className="group flex items-center gap-4">
                <div className="flex h-10 w-10 items-center justify-center border border-zinc-700 transition-colors group-hover:border-[#00FF41]">
                  <MessageCircle className="h-4 w-4 text-zinc-300 group-hover:text-[#00FF41]" />
                </div>
                <a
                  href="https://t.me/gevget"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm font-mono text-zinc-100 transition-colors hover:text-[#00FF41]"
                >
                  @gevget
                </a>
              </div>
        ...
        <div className="relative">
          {isSubmitted ? (
            <div className="mx-auto flex aspect-square max-w-md flex-col items-center justify-center space-y-6 border border-[#00FF41] bg-[#00FF41]/5 p-12 text-center">
              <CheckCircle2 className="h-16 w-16 text-[#00FF41]" />
            ...
            <form
              ...
              className="relative z-10 space-y-8 border border-zinc-700 bg-zinc-900/80 p-8 shadow-2xl shadow-black/40 sm:p-12"
            >
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full border border-zinc-600 bg-black px-12 py-4 text-sm text-white placeholder:text-zinc-500 transition-all focus:border-[#00FF41] focus:outline-none"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full resize-none border border-zinc-600 bg-black px-12 py-4 text-sm text-white placeholder:text-zinc-500 transition-all focus:border-[#00FF41] focus:outline-none"
                  />
                </div>
              </div>
